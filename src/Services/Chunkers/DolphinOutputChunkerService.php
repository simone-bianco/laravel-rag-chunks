...
class DolphinOutputChunkerService
{
     ...
     */
    public function chunkOutputJson(
        string $outputJsonRelativePath,
        array &$errors = []
    ): Generator {
        ...
        $currentFigures = [];
        $pendingFigures = [];
        foreach ($this->yieldFlattenedElements($elementsStream, $errors) as $element) {
            // A. Gestione Figure
     ...
     * @return Generator
     */
    protected function yieldFlattenedElements(Items $pages, array &$errors): Generator
    {
