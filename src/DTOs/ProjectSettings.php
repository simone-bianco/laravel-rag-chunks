...
class ProjectSettings
{
    public function __construct(
        ...
        public ?bool $persistent_memory_enabled = null,
        public ?int $persistent_memory_max_words = null,
    ) {}
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            persistent_memory_enabled: self::nullableBool($data['persistent_memory_enabled'] ?? null),
            persistent_memory_max_words: self::nullableInt($data['persistent_memory_max_words'] ?? null),
        );
    }
    ...
    public function toArray(): array
    {
        return [
            ...
            'persistent_memory_enabled' => $this->persistent_memory_enabled,
            'persistent_memory_max_words' => $this->persistent_memory_max_words,
        ];
    }
