...
class ChunkSearchDataDTO
{
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            weightQuestions: isset($data['weightQuestions']) ? (float) $data['weightQuestions'] : 1.0,
            weightSemanticTags: isset($data['weightSemanticTags']) ? (float) $data['weightSemanticTags'] : 1.0,
